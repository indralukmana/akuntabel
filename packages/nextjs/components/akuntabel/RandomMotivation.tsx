...
const randomMotivations = [
  ...
  {
    quote:
      "People often say that motivation doesn’t last. Well, neither does bathing and that is why we recommend it daily.",
    author: "Zig Ziglar",
  },
  {
  ...
  {
    quote:
      "You can't connect the dots looking forward; you can only connect them looking backward...This approach has never let me down, and it has made all the difference in my life.",
    author: "Steve Jobs",
  },
  {
...
export const RandomMotivation = () => {
  const [motivation, setMotivation] = useState<(typeof randomMotivations)[number]>(randomMotivations[0]);
